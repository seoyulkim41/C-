...
void saveData(void);     //상품정보 저장 함수 추가
void loadData(void);     //상품정보 불러오기 함수
...
int main(void) {
    ...
    while (1) {
        ...
        else if (menu == 5) saveData();     //저장
        else if (menu == 6) loadData();     //불러오기
        else if (menu == 7) {
            printf("프로그램 종료\n");
            break;
        }
...
void saveData(void) {
    ...
    fclose(fp);
    printf("상품정보가 'product.txt' 파일에 저장되었습니다.\n");
}
